...
public class Driver {
    ...
    public static AndroidDriver getAndroidDriver() {
        ...
        if (appiumDriver == null) {
            ...
            caps.setCapability("appPackage", "com.hundred.qibla"); // Hangi uygulama uzerinde calismak istiyorsak apk infodan o uygulamanin degerini aliyoruz
            caps.setCapability("appActivity", "com.hundred.qibla.activity.MainActivity"); // Uygulamayi actiktan sonra hangi sayfadan baslayacagimizi orn; Anasayfa, Profil, vb
